        ...
        <div className="flex flex-col items-center">
          <div className="text-center">
            <p className="text-lg font-medium text-gray-600 font-pj">
              {data.count} people have said how good Rareblocks
            </p>
                ...
                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                  ...
                  <div className="flex items-center mt-8">
                    <img
                      ...
                      src="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/Linkvatar-male-1.png"
                      alt=""
                    />
                    <div className="ml-4">
              ...
              {/* <div className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                  ...
                  <div className="flex items-center mt-8">
                    <img
                      className="flex-shrink-0 object-cover rounded-full w-11 h-11"
                      src="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/Linkvatar-male-2.png"
                      alt=""
                    />
                    <div className="ml-4">
                      <p className="text-base font-bold text-gray-900 font-pj">
